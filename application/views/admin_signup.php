            ...
            <div class="site-wrapper-inner">
                <div class="cover-container">
                    <div class="masthead clearfix">
                        <div class="inner">
                            <h3 class="masthead-brand">Dine Out <span style="font-size:20px;">| Admin Portal</span></h3>
                            <nav>
                    ...
                    <div class="login-form">
                        ...
                        <form id="register-form" class="text-left" method="post" action="<?php echo base_url().'admin/signup_submit';?>">
                            ...
                            <div class="etc-login-form">
                                <p>already have an account? <a href="<?php echo base_url().'admin'; ?>">login here</a></p>
                            </div>
